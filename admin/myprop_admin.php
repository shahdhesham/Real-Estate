...
<body>
    ...
    <?php
    $id = $_POST["id"];
    $sql = "SELECT * FROM property WHERE (ID = '" . $id . "' )or( ownerID ='" . $_POST["id2"] . "' )";
    $result = mysqli_query($conn, $sql);
    if (isset($_POST['update'])) {

        if (!empty($_POST['picture'])) {
            $sql2 = "UPDATE property SET
            picture='" . $_POST['picture'] . "' WHERE ID = '" . $_POST['id'] . "' ";
                    ...
                    ?>
                            ...
                            <div class="col-lg-4 col-md-6 pb-30">
                                <div class="single-property">
                                    <div class="images">
                                        <img class="img-fluid mx-auto d-block" id="myPic" src="<?php echo "/realestate/img/" . $row["picture"]; ?>" alt="" width=100%>
                                    </div>
                                    ...
                                    <div class="desc">
                                        ...
                                        <form name="pics" method="post" action="EditPic.php">
                                            <div class="container">
                                                ...
                                                <div class="button"><input type="file" name="picture" id="image" required> </div>
                                            </div>
                                            <input type="hidden" name="id" value=<?php echo $row["ID"]; ?>>
                                            <input type="hidden" name="ownerid" value=<?php echo $row["ownerID"]; ?>>
