    ...
    <div class="col-lg-6" id="first">
      ...
      <p>
        ...
        <form class="form-inline  " method="post">
          ...
          <input type="text" class="form-control mb-2 mr-sm-2" id="loc" placeholder="Data TO Be Deleted">
          <input type="button" name="loc" onClick="delete_loc()">
    ...
    <div class="col-lg-6" id="second">
      ...
      <p>
        ...
        <form class="form-inline  " method="post">
          ...
          <input type="text" class="form-control mb-2 mr-sm-2" id="type" placeholder="Data TO Be Deleted">
          <input type="button" name="type" onClick="delete_type()">
